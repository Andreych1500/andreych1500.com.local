<?php if(isset($_GET['add'])){ ?>
  <div class="section-interface-k2">
    <div class="line-custom-edit">
      ...
      <a class="back-url" href="/admin/sections/banner/"><?=$messG['Назад']?></a>
    </div>
    ...
    <form class="content-form" action="" method="post" enctype="multipart/form-data">
      ...
      <div class="tabs active-block-tabs">
        ...
        <div class="input-value">
          ...
          <input type="text" name="title" value="<?=(isset($error)? hsc($_POST['title']) : $arResult['title'])?>">
        </div>

        <div class="input-value">
          <div class="name-section">Img Alt:</div>
          <input type="text" name="alt" value="<?=(isset($error)? hsc($_POST['alt']) : $arResult['alt'])?>">
        </div>
...
<?php } else { ?>
  <div class="filter">
    ...
    <form action="" method="get">
      ...
      <a href="/admin/sections/banner/?filterReset=ok"><?=$messG['Відмінити']?></a>
    </form>
  </div>
  ...
  <div class="section-interface-k1">
    ...
    <form action="" method="post" onsubmit="return okFrom();">
      <div class="line-custom-next">
        <a href="/admin/sections/banner/?add=ok" class="add-el icon-plus"><?=$messG['Створити елемент']?></a>
            ...
            <tr data-id="<?=$arResult['id']?>">
              ...
              <td class="relative">
                ...
                <div class="menu-update">
                  <a href="/admin/sections/banner/?edit=<?=$arResult['id']?>"><?=$messG['Редагувати']?></a>
                  <a href="/admin/sections/banner/?delete=<?=$arResult['id']?>"><?=$messG['Видалити']?></a>
                </div>
              </td>
